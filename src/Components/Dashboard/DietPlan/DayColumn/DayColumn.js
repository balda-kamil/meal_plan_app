  ...
  return (
    ...
    >
      ...
      <DietPlanColumnItem
        data={meal6am}
        current={current}
        onClick={() => handleMealDone(meal6am.id)}
      />
      <DietPlanColumnItem
        data={meal9am}
        current={current}
        onClick={() => handleMealDone(meal9am.id)}
      />
      <DietPlanColumnItem
        data={meal12pm}
        current={current}
        onClick={() => handleMealDone(meal12pm.id)}
      />
      <DietPlanColumnItem
        data={meal3pm}
        current={current}
        onClick={() => handleMealDone(meal3pm.id)}
      />
      <DietPlanColumnItem
        data={meal6pm}
        current={current}
        onClick={() => handleMealDone(meal6pm.id)}
      />
      <DietPlanColumnCarboAndWorkout
        carb={carb}
        workoutIsDone={workoutIsDone}
        id={id}
